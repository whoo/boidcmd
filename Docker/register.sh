...
name=/tmp/boidcmd-$$
info=/var/lib/boinc/client_state.xml
...
#curl -qs -X POST -H "Content-type: application/json" -H "Authorization: Bearer $TOKEN" https://api.boid.com/removeDevice --data-binary '{"id":"'$DEVID'"}' > ${name}
